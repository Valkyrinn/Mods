...
public class RenderSummonZombie extends Render
{
    public void renderZS(EntityZombie par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        //this.loadTexture("arrows.png");
        GL11.glPushMatrix();
    ...
    {
        this.renderZS((EntityZombie)par1Entity, par2, par4, par6, par8, par9);
    }
