...
public class ResourceBiomeDecorator extends BiomeDecorator
{
    ...
    public boolean generateLavaLakes;


    public ResourceBiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
    	super();
        ...
        this.plantYellowGen = new WorldGenFlowers(Blocks.yellow_flower);
        this.plantRedGen = new WorldGenFlowers(Blocks.red_flower);
    ...
    protected void decorate()
    {
       ...
       this.generateOres();
        ...
        for (j = 0; doGen && j < i; ++j)
        {
            ...
            WorldGenerator worldgenerator = this.biome.func_150567_a(this.randomGenerator);
        ...
        for (j = 0; doGen && j < this.waterlilyPerChunk; ++j)
        {
            ...
            for (i1 = this.randomGenerator.nextInt(128); i1 > 0 && this.currentWorld.getBlock(k, i1 - 1, l) == Blocks.air; --i1)
            {
                ;
            }
        ...
        if (doGen && this.generateLavaLakes)
        {
            for (j = 0; j < 20; ++j)
            {
                k = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
